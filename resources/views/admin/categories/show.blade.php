...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold text-gray-900">Категория: {{ $category->nom }}</h1>
        </div>
    ...
    <div class="mt-5 border-t border-gray-200">
        <dl class="sm:divide-y sm:divide-gray-200">
            ...
            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                <dt class="text-sm font-medium text-gray-500">Количество товаров</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
    ...
    <div class="mt-8">
        <h2 class="text-lg font-medium text-gray-900">Товары в этой категории</h2>
        ...
        @else
            <p class="mt-2 text-sm text-gray-500">В этой категории пока нет товаров.</p>
        @endif
    </div>
</div>
@endsection