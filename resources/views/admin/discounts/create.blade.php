...
@section('title', 'Создать Скидку')

@section('content')

<div class="px-4 sm:px-6 lg:px-8"> <div class="sm:flex sm:items-center"> <div class="sm:flex-auto"> <h1 class="text-xl font-semibold text-gray-900">Создать Новую Скидку</h1> </div> </div>
            ...
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-1">
                        <label for="montant_remise" class="block text-sm font-medium text-gray-700">Сумма</label>
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-2">
                        <label for="date_expiration" class="block text-sm font-medium text-gray-700">Дата Истечения</label>
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-1">
                        <label for="max_uses" class="block text-sm font-medium text-gray-700">Максимальное Количество Использований</label>
