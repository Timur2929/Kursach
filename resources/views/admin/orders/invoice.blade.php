...
<body>
    <div class="invoice-container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ number_format($item->price * $item->quantity, 2) }} Руб</td>
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="totals">
            ...
            <div class="total-row">
                <span>Discount:</span>
                <span>-{{ number_format($order->discount, 2) }} Руб</span>
            </div>
            @endif
...
<div class="footer">
                ...
                <p>Если у вас есть вопросы по этому счету, пожалуйста, свяжитесь с нашей службой поддержки.</p>
        </div>
