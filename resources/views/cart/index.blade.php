...
<div class="bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-8">Ваша Корзина</h1>
        ...
        @if(empty($cartItems))
            <div class="bg-white rounded-lg shadow p-6 text-center">
                ...
                <p class="mt-2 text-gray-600">Посмотрите наши товары и добавьте что-нибудь в корзину</p>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            @if($item['product']->on_sale)
                                                <span class="font-bold">{{ number_format($item['product']->sale_price, 2) }} Руб</span>
                                                <span class="text-xs text-gray-500 line-through ml-1">{{ number_format($item['product']->prix, 2) }} Руб</span>
                                            @else
                                                <span class="font-bold">{{ number_format($item['product']->prix, 2) }} Руб</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
