...
<div class="bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="md:flex md:space-x-8">
            ...
            <div class="md:w-2/3">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Данные доставки</h2>
                ...
                <form action="{{ route('checkout.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Персональные данные</h3>
                        </div>
                        ...
                        <div class="md:col-span-2 mt-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Адрес доставки</h3>
                        </div>
                        ...
                        <div>
                            <label for="zip_code" class="block text-sm font-medium text-gray-700">Почтовый индекс</label>
                        ...
                        <!-- Способ оплаты -->
                        <div class="md:col-span-2 mt-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Способ оплаты</h3>
            ...
            <div class="md:w-1/3 mt-8 md:mt-0">
                <div class="bg-white shadow rounded-lg p-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-6">Сводка заказа</h2>
