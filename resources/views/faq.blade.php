        ...
        <div class="border-b border-gray-200">
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div x-data="{ open: false }" class="px-6 py-4">
                    ...
                    <div x-show="open" x-collapse class="mt-2 text-gray-600">
                        <p>Вы можете изменить или отменить заказ в течение 1 часа после оформления. По истечении этого срока, пожалуйста, немедленно свяжитесь с нами в VK <a href="mailto:vk.com/kamenika" class="text-emerald-600 hover:underline">vk.com/kamenika</a> или по телефону +79099099988. Мы сделаем все возможное, чтобы учесть ваши пожелания.</p>
                    </div>
                </div>
            </div>
        </div>
